...
class fourth_floor : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val floorSelect = findViewById<ImageButton>(R.id.drp_fourth)
        ...
        officeSelect.setOnClickListener {
            val dialogBinding = layoutInflater.inflate(R.layout.fourth_floor_office, null)
